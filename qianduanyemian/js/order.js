    ...
    CallAPI({requestMethod: "listUserPayments"}, function (data) {
        ...
        for (var i = 0;i < data.length;i++) {
            if (data[i].type == 0) {    //Plane
                ...
                html += '<div class="ticket" onclick="goPayment('+ data[i].plane_id + ',' + data[i].state +')"><div class="bar1"><img src="./img/Capa_1@1x.png" style="margin-left: 11px;margin-top:10px;vertical-align: baseline;float: left;" />'+
                ...
                html += '<div class="hotel" onclick="goPayment('+ data[i].plane_id + ',' + data[i].state +')"><div class="bar1"><img src="./img/hotel@1x.png" style="margin-left: 11px;margin-top:10px;vertical-align: baseline;float: left;" />'+
...
function goPayment(paymentId, state) {
    switch (state) {
        case 0:
            ...
            location.href='chat.html?addition={"checkId":' + paymentId + '}';
            break;
        case 1:
